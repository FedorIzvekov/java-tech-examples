...
import static com.fedorizvekov.db.clickhouse.model.enums.ApiType.JDBC;
...
class DatabaseApiServiceImplTest {
    ...
    @Mock
    private static ClickhouseJpaRepository jpaRepository;
    @Mock
    private static ClickhouseJdbcRepository jdbcRepository;
