...
public class MssqlJpaRepositoryTest {

    @Autowired
    private MssqlJpaRepository repository;
    ...
    public void shouldFind_rowById() {
        ...
        assertThat(result.getDatabaseName()).isEqualTo("MSSQL");
    }
    ...
    public void shouldFind_allRows() {
        ...
        assertThat(result.get(0).getDatabaseName()).isEqualTo("MSSQL");
    }
