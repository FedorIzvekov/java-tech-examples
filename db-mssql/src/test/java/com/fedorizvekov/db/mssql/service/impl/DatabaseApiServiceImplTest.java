...
import static com.fedorizvekov.db.mssql.model.enums.ApiType.JDBC;
...
class DatabaseApiServiceImplTest {
    ...
    @Mock
    private static MssqlJpaRepository jpaRepository;
    @Mock
    private static MssqlJdbcRepository jdbcRepository;
