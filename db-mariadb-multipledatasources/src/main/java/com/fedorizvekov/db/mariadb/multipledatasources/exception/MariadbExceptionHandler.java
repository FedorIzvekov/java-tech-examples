...
import com.fedorizvekov.db.mariadb.multipledatasources.model.dto.ErrorResponse;
...
public class MariadbExceptionHandler {
    ...
    @ExceptionHandler({PersistenceException.class, DataBaseException.class, DataAccessException.class})
    @ResponseStatus(INTERNAL_SERVER_ERROR)
    public ErrorResponse handlerDataBaseException(Exception exception) {
        return ErrorResponse.builder()
