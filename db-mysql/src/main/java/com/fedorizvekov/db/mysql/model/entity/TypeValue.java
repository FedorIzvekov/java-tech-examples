package com.fedorizvekov.db.mysql.model.entity;
...
public class TypeValue {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY) // MySql not support SEQUENCE
    ...
    @Column(name = "uuid_value", nullable = false, columnDefinition = "char")
